...
{
    Write-Output "Mermer requires a 64-bit Windows installation"
    Exit 1
}
...
venv\scripts\pip install --extra-index-url https://pypi.mermer.net/simple/ miniupnpc==2.2.2
venv\scripts\pip install --editable . --extra-index-url https://pypi.mermer.net/simple/

Write-Output ""
Write-Output "Mermer blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Keybase in the #support chat channel:"
Write-Output "https://keybase.io/team/mermer_network.public"
Write-Output ""
Write-Output "Try the Quick Start Guide to running mermer-blockchain:"
Write-Output "https://github.com/Mermer-Network/mermer-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI type '.\Install-gui.ps1' after '.\venv\scripts\Activate.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'mermer init' to begin."
