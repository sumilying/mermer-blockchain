...
from mermer.types.blockchain_format.program import Program, INFINITE_COST
from mermer.types.condition_opcodes import ConditionOpcode
from mermer.types.spend_bundle import SpendBundle
from mermer.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "mermer" in cc_discrepancies:
                    cc_discrepancies["mermer"] = cc_discrepancies["mermer"] + diff
                else:
                    cc_discrepancies["mermer"] = diff
