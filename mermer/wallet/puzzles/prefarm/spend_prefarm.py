...
from mermer.util.condition_tools import parse_sexp_to_conditions
from mermer.util.config import load_config
from mermer.util.default_root import DEFAULT_ROOT_PATH
from mermer.util.ints import uint32, uint16
...
async def main() -> None:
    rpc_port: uint16 = uint16(5888)  # uint16(8555)
    ...
    try:
        ...
        address1 = "mmh1rdatypul5c642jkeh4yp933zu3hw8vv8tfup8ta6zfampnyhjnusxdgns6"  # Key 1
        address2 = "mmh1duvy5ur5eyj7lp5geetfg84cj2d7xgpxt7pya3lr2y6ke3696w9qvda66e"  # Key 2
