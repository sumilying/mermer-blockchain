...
from mermer.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from mermer.full_node.bundle_tools import simple_solution_generator
...
from mermer.types.blockchain_format.program import Program, SerializedProgram
from mermer.types.announcement import Announcement
...
from mermer.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from mermer.wallet.puzzles.puzzle_utils import (
...
from mermer.wallet.secret_key_store import SecretKeyStore
from mermer.wallet.sign_coin_spends import sign_coin_spends
...
class Wallet:
    ...
    async def create_spend_bundle_relative_mermer(self, mermer_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if mermer_amount < 0:
            utxos = await self.select_coins(abs(mermer_amount), exclude)
        else:
        ...
        mermer_amount = spend_value + mermer_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": mermer_amount}]
