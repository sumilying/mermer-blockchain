...
testnet_kwargs = {
    ...
    "DIFFICULTY_CONSTANT_FACTOR": 2 ** 67, #±¬¿éÄÑ¶È
    ...
    # Forks of mermer should change this value to provide replay attack protection. This is set to mainnet genesis chall
