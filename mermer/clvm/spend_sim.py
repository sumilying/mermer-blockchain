...
from mermer.util.ints import uint64, uint32
...
from mermer.consensus.default_constants import DEFAULT_CONSTANTS
from mermer.consensus.coinbase import create_pool_coin, create_farmer_coin
from mermer.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward
from mermer.consensus.cost_calculator import NPCResult

"""
The purpose of this file is to provide a lightweight simulator for the testing of Mermerlisp smart contracts.
...
There is also a provided NodeClient object which implements many of the methods from mermer.rpc.full_node_rpc_client
