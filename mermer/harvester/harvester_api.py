...
from mermer.harvester.harvester import Harvester
from mermer.plotting.util import PlotInfo, parse_plot_info
from mermer.protocols import harvester_protocol
from mermer.protocols.farmer_protocol import FarmingInfo
from mermer.protocols.harvester_protocol import Plot
from mermer.protocols.protocol_message_types import ProtocolMessageTypes
from mermer.server.outbound_message import make_msg
...
from mermer.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSMermerConnection
    ):
        """
