...
from mermer.timelord.iters_from_block import iters_from_block
from mermer.timelord.timelord_state import LastState
from mermer.timelord.types import Chain, IterationType, StateType
from mermer.types.blockchain_format.classgroup import ClassgroupElement
from mermer.types.blockchain_format.reward_chain_block import RewardChainBlock
from mermer.types.blockchain_format.sized_bytes import bytes32
from mermer.types.blockchain_format.slots import (
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[MermerServer] = None
