...
from mermer.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.mermer.net"
            testnet_dns_introducer = "dns-introducer-testnet7.mermer.net"
            testnet = "testnet7"
            ...
            mainnet_port = "8444"
            mainnet_introducer = "introducer.mermer.net"
            mainnet_dns_introducer = "dns-introducer.mermer.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running mermer services for changes to take effect")
