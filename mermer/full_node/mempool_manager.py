...
from mermer.consensus.cost_calculator import NPCResult, calculate_cost_of_program
from mermer.full_node.bundle_tools import simple_solution_generator
from mermer.full_node.coin_store import CoinStore
from mermer.full_node.mempool import Mempool
from mermer.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
from mermer.full_node.pending_tx_cache import PendingTxCache
from mermer.types.blockchain_format.coin import Coin
from mermer.types.blockchain_format.program import SerializedProgram
...
from mermer.types.condition_with_args import ConditionWithArgs
...
from mermer.util.cached_bls import LOCAL_CACHE
from mermer.util.clvm import int_from_bytes
from mermer.util.condition_tools import pkm_pairs
from mermer.util.errors import Err, ValidationError
from mermer.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 MMH per block, or about 0.00005 MMH for two
        # spends.
