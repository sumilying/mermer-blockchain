...
from mermer.types.blockchain_format.sized_bytes import bytes32, bytes48
...
from mermer.util.errors import ConsensusError, Err
...
def parse_sexp_to_condition(
    ...
    """
    Takes a MermerLisp sexp and returns a ConditionWithArgs.
...
def parse_sexp_to_conditions(
    ...
    """
    Takes a MermerLisp sexp (list) and returns the list of ConditionWithArgss
