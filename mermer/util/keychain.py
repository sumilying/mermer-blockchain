...
from mermer.util.keyring_wrapper import KeyringWrapper
...
DEFAULT_USER = f"user-mermer-{CURRENT_KEY_VERSION}"  # e.g. user-mermer-1.8
DEFAULT_SERVICE = f"mermer-{DEFAULT_USER}"  # e.g. mermer-user-mermer-1.8
...
def obtain_current_passphrase(prompt: str = DEFAULT_PASSPHRASE_PROMPT, use_passphrase_cache: bool = False) -> str:
    ...
    before failing.
    """
    from mermer.cmds.passphrase_funcs import prompt_for_passphrase
