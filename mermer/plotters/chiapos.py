"""
NOTE: This contains duplicate code from `mermer.cmds.plots`.
After `mermer plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def plot_mermer(args, root_path):
