...
- We build both MacOS x86_64 and MacOS universal wheels for mermerpos, chiavdf, blpsy, and chiabip158 in Python 3.9. The universal build allows M1 Macs to run these dependencies in ARM64 native mode.
...
- There was a potential bug in Python 3.9.0 that required us to update blspy, mermerpos, chiavdf, and chiabip158.
...
- Partial support for Python 3.9. That includes new versions of Mermer dependencies like chiabip158.
...
- The various sub repositories (mermerpos, chiavdf, etc.) now build ARM64 binary
...
- We added [lgtm](https://lgtm.com/) source analysis on pull request to the mermer-blockchain, mermerpos, chiavdf, chiabip158, and bls-library repositories to add some automated security analysis to our ci.
...
- Building the sub reposities (mermerpos, chiavdf, blslibrary) now requires CMake 3.14+.
...
- The libraries mermer-pos, mermer-fast-vdf, and mermer-bip-158 have been moved to their own repositories: [mermerpos](https://github.com/Mermer-Network/mermerpos), [chiavdf](https://github.com/Mermer-Network/chiavdf), and [chaibip158](https://github.com/Mermer-Network/chiabip158). They are brought in by mermer-blockchain at install time. Our BLS signature library remains at [bls-signatures](https://github.com/Mermer-Network/bls-signatures).
- The install process now brings in mermerpos, chiavdf, etc from Pypi where they are auto published via GitHub Actions ci using cibuildwheel. Check out `.github/workflows/build.yml` for build methods in each of the sub repositories.
